...
INSERT INTO universidades (nombre_universidad, direccion, ciudad) VALUES ('Universidad Pontificia Bolivariana seccional Bucaramanga', 'via piedecuesta', 'floridablanca');

INSERT INTO carreras (id_universidad, nombre_carrera) VALUES (1, 'sistemas');

Insert INTO usuarios (nombre_usuario, apellido_usuario, sexo, fecha_nacimiento, correo, contrasena, id_carrera, id_universidad, celular, imagen_perfil, estado)           
VALUES(                               
'Jairo',                           
  'Sanchez',
  True,               
